...
To fulfill our requirements, we have developed a sophiticated but easy to use framework for controlling three aspects of our workflow needs: (a) the placement of the workflow onto a number of different compute resources including HPC, cloud, and loacl computing while also providing adaptations to various batch queues, (b) the coordination of task-based parallelelism to execute the workflow on the various resources, and (c) the coordination of hyperparameter sweeps used in the application that we call experiment coordinator.
